...
export const ArtistAlbumCard = memo(function ArtistAlbumCard({
  artist,
  count,
  artwork,
  size = 152,
  ...
  return (
    <Pressable onPress={handlePress} style={({ pressed }) => [{ opacity: pressed ? 0.88 : 1, width: size }]}>
      <View style={[styles.cover, { width: size, height: size, backgroundColor: palette[2] }]}>
        {artwork ? (
          <Image
            source={{ uri: artwork }}
